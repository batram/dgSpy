	...
	public class BootstrapStartTests {
		...
		public void A_guarded_install_resolves_the_graph_from_bytes_and_observes_an_event() {
			using (var runner = BootstrapRunner.Create("bootstrap-happy-path")) {
				...
				Assert.Equal("HookLab.Contracts,HookLab.Probe.CorDebug,Microsoft.CodeAnalysis,Microsoft.CodeAnalysis.CSharp,System.Buffers,System.Collections.Immutable,System.Memory,System.Reflection.Metadata,System.Runtime.CompilerServices.Unsafe", report["payload_identities"]);
				...
				Assert.Equal("9", report["payload_load_count"]);
