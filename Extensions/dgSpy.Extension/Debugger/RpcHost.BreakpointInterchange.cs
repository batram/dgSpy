...
namespace dgSpy.Extension {
	sealed partial class RpcHost {
		...
		async Task<BreakpointImportResult> ImportBreakpointsAsync(RpcRequest req,CancellationToken token) {
			CheckSession(req); var document=req.Arguments["document"]?.ToObject<BreakpointDocument>()??throw new RpcException("invalid_arguments","document is required.");
