...
internal sealed class WatcherStatusStore {
	readonly string path; readonly object gate=new(); readonly Dictionary<string,object> results=new(StringComparer.Ordinal); DateTime startedUtc=DateTime.UtcNow;
