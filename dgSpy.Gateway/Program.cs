...
public static class ToolCatalog {
	...
	public static readonly object[] All = {
		...
		Tool("get_events", "Read buffered lifecycle and debugger events without consuming them. Phase 2 uses this to preserve terminal target-exit details; Phase 3 will expand the event kinds and payloads.", new { session_id=new { type="string" }, after_event_id=new { type="integer" } }, new[]{"session_id"}),
